#!/usr/bin/env python3
"""Roblox-codex-launcher screen analysis tool with overlay and hotkeys."""
import argparse
import logging
import threading
import time
...
class Robloxcodexlauncherstudio:
 ...
 sct = mss()
 fps = self.cfg.get("capture", {}).get("fps", 60)
 frame_time = 1.0 / fps
 ...
 def start(self):
 log.info("roblox-codex-launcher-studio starting...")
 ...
 self.overlay.close()
 self.hotkeys.stop()
 log.info("roblox-codex-launcher-studio stopped")
...
def main():
 ...
 app = Robloxcodexlauncherstudio(args.config)
 app.start()
